...
USER_VARS=("NUM_CLUSTERS" "NUM_RANDOM_SAMPLING")
# log variables and script to to TURBINE_OUTPUT directory
log_script

# echo's anything following this to standard out
set -x
SWIFT_FILE=uc3.swift
swift-t -n $PROCS $MACHINE -p -I $EQR -I $ZOMBIES -r $EQR -r $ZOMBIES $EMEWS_PROJECT_ROOT/swift/$SWIFT_FILE $CMD_LINE_ARGS
