...
ln -s $CORE/plugins $SANDBOX/$RAND/plugins
...
cp -r $CORE/workspace/ $SANDBOX/$RAND/

cp -r $CORE/data-demo $SANDBOX/$RAND/data

cp $CORE/data/projects.php $SANDBOX/$RAND/data/projects.php
